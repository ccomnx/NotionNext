 ...
 */
module.exports = {
  ANALYTICS_VERCEL: process.env.NEXT_PUBLIC_ANALYTICS_VERCEL || false, // Vercel Web Analytics - see https://vercel.com/docs/analytics/quickstart | Set to true to enable
